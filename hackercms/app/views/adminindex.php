...
<tr><td width="15%"><?=lang('user_name')?></td><td width="35%"><?=$user['username']?></td><td width="15%"><?=lang('hackercmsversion')?></td><td width="35%"><?=lang('system_version')?></td></tr>
...
<tr><th width="50%" align="left" colspan="2"><?=lang('sitetongji')?></th>
	...
	<th width="35%" align="right"><a href="http://bbs.hackercms.com" target="_blank"><?=lang('bugsubmit')?></a>&nbsp;&nbsp;&nbsp;<a href="http://www.hackercms.com" target="_blank"><?=lang('moredynamic')?></a></th></tr>

<tr><td width="15%"><?=lang('func_down')?></td><td width="35%"><?=$this->db->count_all('down')?></td><td width="50%"  style="padding:0;" colspan="2" rowspan="6"><iframe width="100%" style="margin: 0;" height="150" src="http://www.hackercms.com/help" frameBorder="0" width="295" scrolling="no"></iframe></td></tr>
