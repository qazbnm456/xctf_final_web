...
<table width="100%" height="80" border="0" cellpadding="0" cellspacing="1">
	<tr><td rowspan="2" width="150"><div class="logo"><a href="<?=base_url()?>" target="_blank"><img src="<?=base_url()?>images/hackercms.gif" width=150></a></div></td>
...
<i>|</i>
<a href="http://bbs.hackercms.com" target="_blank"><?=lang('hackercms_bbs')?></a>
<i>|</i>
<a href="http://www.hackercms.com/shouce" target="_blank"><?=lang('hackercms_manual')?></a>
 &nbsp;&nbsp;</div></td>
	</tr>
	<tr>
