...
<div class="main">
	...
	<div class="news">
		<span class="head"><span><?=lang('article')?></span><a href="<?=site_url('category/news'.$langurl)?>"  class="fr"><?=lang('more')?></a></span>
		 <ul>
			<?php $tmpData = hackercms_modellist('article',0,'default',7,0);?>
			<?php foreach($tmpData as $item):?>
	...
	<div class="main_left">
		<div class="ask">
			...
			<div class="ask_content">
				<div class="ask_first">
					<?=hackercms_fragment('index_cpjs')?>
				</div>
				<div class="ask_list">
					<ul>
					<?php $tmpData = hackercms_modellist('ask',0,'default',5,0);?>
					<?php foreach($tmpData as $item):?>
		...
		<div class="anli">
			...
			<div class=anli_content>
				<ul>
				<?php $tmpData = hackercms_modellist('product',0,'default',4,0);?>
				<?php foreach($tmpData as $item):?>
				<li>
	...
	<div class="main_right">
		...
		<div class=product_content>
			...
			<?php $tmpData = hackercms_modellist('down',0,'default',4,0);?>
				<?php foreach($tmpData as $item):?>
