...
<div class="main">
	...
	<div class="mainright">
		...
		<div class="rightmiddle">
			<ul class="centerlist">
				<?php $tmpData = hackercms_tagsData('article',$tags,5);?>
				...
				<?php $tmpData = hackercms_tagsData('product',$tags,5);?>
				<?php foreach($tmpData as $item):?>
				<li>[<a href="<?=$item['categoryurl']?>"><?=$item['categoryname']?></a>] <a href="<?=$item['url']?>" target="_blank"><?=$item['title']?></a><span><?=$item['puttime']?></span></li>
				<?php endforeach;?>
				<?php unset($tmpData,$item);?>
				
				<?php $tmpData = hackercms_tagsData('ask',$tags,5);?>
				<?php foreach($tmpData as $item):?>
				<li>[<a href="<?=$item['categoryurl']?>"><?=$item['categoryname']?></a>] <a href="<?=$item['url']?>" target="_blank"><?=$item['title']?></a><span><?=$item['puttime']?></span></li>
				<?php endforeach;?>
				<?php unset($tmpData,$item);?>
				
				<?php $tmpData = hackercms_tagsData('down',$tags,5);?>
				<?php foreach($tmpData as $item):?>
				<li>[<a href="<?=$item['categoryurl']?>"><?=$item['categoryname']?></a>] <a href="<?=$item['url']?>" target="_blank"><?=$item['title']?></a><span><?=$item['puttime']?></span></li>
				<?php endforeach;?>
				<?php unset($tmpData,$item);?>
				
				<?php $tmpData = hackercms_tagsData('hr',$tags,5);?>
				<?php foreach($tmpData as $item):?>
				<li>[<a href="<?=$item['categoryurl']?>"><?=$item['categoryname']?></a>] <a href="<?=$item['url']?>" target="_blank"><?=$item['title']?></a><span><?=$item['puttime']?></span></li>
				<?php endforeach;?>
				<?php unset($tmpData,$item);?>
