...
<link rel="shortcut icon" href="<?=hackercms_path('images/favicon.ico');?>" />
...
<div class="header">
	...
	<div class="headerr">
		...
		<ul class="nav_top">
		<?php $tmpData = hackercms_navigation(4);?>
		<?php foreach($tmpData as $item):?>
	...
	<div class="nav"><?=hackercms_category();?></div>
</div>